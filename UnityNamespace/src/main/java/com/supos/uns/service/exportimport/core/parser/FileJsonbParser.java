...
@Slf4j
public class FileJsonbParser extends AbstractParser {
...
//            return null;
//        }
        createTopicDto.setAddFlow(false);
        createTopicDto.setFields(new FieldDefine[]{new FieldDefine("json", FieldType.STRING)});

//        Triple<Boolean, Integer, FieldDefine[]> checkFieldResult = checkFields(false, flagNo, fileDto.getFields(), context);
